"""CLI and server executor for HR agent.

Examples:
  python -m agents.hr_agent.executor --resume-file path/to/resume.txt
  python -m agents.hr_agent.executor --serve --port 8103
"""
...
from .main import HRResumeAnalyzer
...
def build_parser() -> argparse.ArgumentParser:
	parser = argparse.ArgumentParser(description="Run HR resume analysis.")
	parser.add_argument("--resume-file", type=str, help="Path to a raw resume text file.")
	parser.add_argument("--resume-text", type=str, help="Raw resume text as argument.")
	parser.add_argument("--model", type=str, default=None, help="Override model name.")
	parser.add_argument("--serve", action="store_true", help="Run A2A HTTP server mode.")
	parser.add_argument("--host", type=str, default="127.0.0.1", help="Server host.")
	parser.add_argument("--port", type=int, default=8103, help="Server port.")
	return parser
...
def main() -> int:
	...
	analyzer = HRResumeAnalyzer(model_name=args.model)
